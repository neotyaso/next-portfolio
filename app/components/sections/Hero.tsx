  ...
  return (
    <div id="Home" className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden perspective-1000">
      ...
      <motion.div 
        ...
        className="absolute top-[-10%] right-[-5%] w-96 h-96 bg-linear-to-br from-indigo-50 to-blue-50 rounded-full blur-3xl opacity-60 pointer-events-none"
      />
      <motion.div 
        style={{ y: y2, rotate: -10 }}
        className="absolute bottom-[-10%] left-[-5%] w-120 h-120 bg-linear-to-tr from-rose-50 to-pink-50 rounded-full blur-3xl opacity-60 pointer-events-none"
      />
